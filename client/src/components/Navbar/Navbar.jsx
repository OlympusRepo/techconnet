      ...
      <div className="contain">
        <div className="w-full flex items-center justify-between py-4 relative">
          ...
          <nav className="flex items-center justify-end gap-7 font-medium text-base">
            <Link to="/gigs?cat" className="cursor-pointer hidden lg:flex">
              Explore
            </Link>
            {!authUser?.isTechnician && (
              <>
                <p className="cursor-pointer hidden lg:flex">
                  Techcon Business{" "}
                </p>
                <Link to="/join" className="cursor-pointer hidden lg:flex">
                  Become a technician
                </Link>
              </>
            )}
            {authUser ? renderAuthLinks() : renderGuestLinks()}
          </nav>
        </div>
      </div>
      <div
